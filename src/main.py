...
def main():
    ...
    # Second paper :
    #test_df = '../NovaAD_Plus/datasets/HDFS/1_HDFS_Splitted_Datasets/train_df.pkl'
    #train_df = '../NovaAD_Plus/datasets/HDFS/1_HDFS_Splitted_Datasets/test_df.pkl'
    #val_df = '../NovaAD_Plus/datasets/HDFS/1_HDFS_Splitted_Datasets/val_df.pkl'
