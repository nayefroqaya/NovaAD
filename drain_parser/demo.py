...
#input_dir  = '../datasets/TH_2G/' # The input directory of log file
#output_dir = '../datasets/TH_2G/'  # The output directory of parsing results
#log_file   = 'TH_2G.log'  # The input log file name
